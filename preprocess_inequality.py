...
in_topics_path = 'data/TroInequality/tfidf_top10_title_abstract.csv' # we are using this to filter out any wiki titles that exactly match labels from the topics


# now processing for wiki_sent, if you want to prep for wiki_tfidf then its 'data/wiki_tfidf/'
out_data_path='data/TroInequality/'
